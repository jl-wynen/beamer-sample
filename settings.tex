...
% all custom listing environments take keyword args and pass them along to lstlistings
% but empty [] must be given if no optional args are used!
...
\lstdefinestyle{aiphifile}{
  ...
  basicstyle=\scriptsize\dvfamily\color{black!70!white},  % default font size
  breakatwhitespace=false,  % if true, lines are only broken at whitespaces
  breaklines=true,
  breakindent=2em,
  postbreak=\mbox{\textcolor{aiphired}{\rotatebox[origin=c]{180}{$\Lsh$}}},
...
%
  frame=l,                                  % frame around code, show only to the left
  framerule=1.5pt,                          % frame width
  rulecolor=\color{black!80!white}, % colour of frame
%
  numbers=left,  % line numbers, one of none, left, right
  numbersep=6pt, % distance of line numbers from code
  numberstyle=\tiny\color{black},  % text style of line numbers
...
\lstnewenvironment{aiphifile}[1][]
{\lstset{style=aiphifile}}
{\lstset{style=aiphifile}}
...
%
  frame=l,                                  % frame around code, show only to the left
  framerule=1.5pt,                          % frame width
  rulecolor=\color{black!75!white}, % colour of frame
%
  numbers=left,  % line numbers, one of none, left, right
  numbersep=6pt, % distance of line numbers from code
  numberstyle=\tiny\color{black},  % text style of line numbers
