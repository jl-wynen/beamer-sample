...
\NewTColorBox{icitebox}{m}{
  ...
  arc=0pt,
  boxsep=-0.1pt,  % negative to remove gap between title colorbox and rule
  ...
  title={\setlength{\fboxsep}{1.5pt}\colorbox{aiphigreen!90!white}{#1}},  % extra box to give background to title
}
...
\newcommand{\arxiv}[1]{\icite{arXiv}{#1}}
